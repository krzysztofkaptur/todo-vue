...
export default {
  ...
  methods: {
    ...
    handleCheckbox({ id, completed }) {
      this.$apollo.mutate({
        mutation: gql`
          mutation editTodoCompletion($id: ID!, $completed: Boolean!) {
            editTodoCompletion(id: $id, completed: $completed) {
              id
            }
          }
        `,
    ...
    editTodo({ id, newTitle }) {
      this.$apollo.mutate({
        mutation: gql`
          mutation editTodoTitle($id: ID!, $title: String!) {
